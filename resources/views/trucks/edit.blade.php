            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group mb-3">
                        ...
                        <input type="text" name="type" value="{{ $row->type }}" id="type" class="form-control">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" name="traffic_license_number" value="{{ $row->traffic_license_number }}"
                            id="traffic_license_number" class="form-control">
                ...
                <div class="col-md-6">
                    <div class="form-group mb-3">
                        ...
                        <input type="text" name="passengers_number" value="{{ $row->passengers_number }}"
                            id="passengers_number" class="form-control">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" name="load" value="{{ $row->load }}" id="load" class="form-control">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" name="kilometer_number" value="{{ $row->kilometer_number }}"
                            id="kilometer_number" class="form-control">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" name="technical_status" value="{{ $row->technical_status }}"
                            id="technical_status" class="form-control">
                ...
                <div class="col-md-12">
                    <div class="row">
                        <div class="form-group col-md-6 mb-3 mb-3">
                            <label for="year">السنة</label>
                            <div class="input-group">
                                <input type="text" name="year" value="{{ $row->year ?? " 04/24/2020"}}"
                                    class="form-control drgpicker" id="year" aria-describedby="button-addon">
                ...
                <div class="col-md-12">
                    <div class="form-group mb-3">
                        ...
                        <textarea class="form-control" id="parts_description" name="parts_description"
                            rows="4">{{ $row->parts_description }}</textarea>
