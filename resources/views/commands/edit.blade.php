    ...
    <div id="vehicle-forms-container">
        <div class="vehicle-form">
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group mb-3">
                        ...
                        <input type="time" name="task_start_time[]" value="{{ $row->task_start_time_formatted }}" id="task_start_time" class="form-control">
            ...
            <div class="form-group col-md-4 mb-3">
                ...
                <select class="form-control" id="escort_id" name="escort_id[]" multiple data-live-search="true">
