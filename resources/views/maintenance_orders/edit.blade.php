        ...
        <div class="vehicle-form">
                    ...
                    @foreach($row->product as $index => $product)
                        <div class="row" style="margin: 10px">
                            <div class="form-group col-md-1 mb-3">
                                <input class="form-control" name="procedure_number[]" value="{{ $index + 1 }}" placeholder="الرقم" autocomplete="true">
                            </div>
                            ...
                            <div class="form-group col-md-2 mb-3">
                                <select class="form-control" name="procedure_id[]">
                                    ...
                                    @foreach($procedures as $proc)
                                        <option value="{{ $proc->id }}" {{ $proc->id == $product->pivot->procedure_id ? 'selected' : '' }}>
                                            {{ $proc->name }}
                                        </option>
                                    @endforeach
                                </select>
            ...
            <div class="row">
                <div class="form-group col-md-6 mb-3">
                    ...
                    <textarea class="form-control" id="notes" name="notes" rows="4">{{ old('notes', $row->notes) }}</textarea>
